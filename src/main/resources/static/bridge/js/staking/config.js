	...
	$.config = {
		chains : [
			{chain: "Smart Chain", coin: "BNB", chainId: 56, projects: [
				{name: "Compensation Pool", stake: {coin: "USDT", address: "0x55d398326f99059ff775485246999027b3197955"}, reward: {coin: "DFC"}, apy: "500%", address: "0xb7ca6e69D7d14aE9F068037F4B10Fb62F1DA8d19"},

$(function(){
	// 配置
	const ERC20_ADDR = "0xdB5556A2d8765BCE5f5c4b239A815D3C5d3eA812";
	...
	const MAIN_ADDR = "0x82e1b37cA0D71AFaD8478ABe9d264b39D2f03606";
	var chain = {
		id: 97,
	...
	// 链接钱包
	$.connectWallet(chain.id, chain.name, function(){
		$.tokenContract = $.coinContract(chain.id, ERC20_ADDR);
	...
	// tokenOfOwnerByIndex
	$.tokenOfOwnerByIndex = async function(owner, index, callback){
		let result = await $.mainContract.methods
	...
	// balanceOf
	$.balanceOf = async function(owner, callback){
		let result = await $.mainContract.methods
			.balanceOf(owner)
			.call();
		callback(result);
